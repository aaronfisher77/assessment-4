...
let school1 = School(name: "BCHS", numberOfStudents: 2000, publicOrprivate: "Public", yearBuilt: 1974)
print()
...
let school2 = Highschool(name: "Barren County High School", numberOfStudents: 1700, publicOrprivate: "public", yearBuilt: 1974, highschoolRival: "Glasgow", highschoolMascot: "Trojan")
print()
school2.schoolDescription()
print()
print()
...
let Hogwarts = magicalHighschool(name: "Hogwarts", numberOfStudents: 1000, publicOrprivate: "Private", yearBuilt: 0001, highschoolRival: "Voldemort", highschoolMascot: "Owl", castleSize: 5000, numberOfSecretPassages: 7777)
print()
Hogwarts.pepRally()
print()
